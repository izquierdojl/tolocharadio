...
export function requireAuth(ctx: {
  ...
  auth: { publicUser(userId: number): Promise<{ id: number; email: string; name: string | null; theme: "light" | "dark"; defaultView: "explorar" | "favoritos" | "historial"; createdAt: number } | null> };
}) {
